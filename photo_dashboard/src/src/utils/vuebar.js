...
(function(){
    ...
    \*------------------------------------*/
    var VfVuebar = {};
    VfVuebar.install = function(Vue, installOptions){
        ...
        Vue.vfVuebar = publicMethods();
        Vue.prototype.$vfVuebar = publicMethods();
    ...
    if (typeof exports === 'object' && typeof module === 'object') {
        module.exports = VfVuebar;
    } else if (typeof define === 'function' && define.amd) {
        define(function () { return VfVuebar; });
    } else if (typeof window !== typeof void 0) {
        window.Vuebar = VfVuebar;
    }
